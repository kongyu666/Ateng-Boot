package io.github.kongyu666.common.web.interceptor;
...
import io.github.kongyu666.common.web.filter.RepeatedlyRequestWrapper;
...
public class PlusWebInvokeTimeInterceptor implements HandlerInterceptor {
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) throws Exception {
        if (!prodProfile.equals(SpringUtils.getActiveProfile())) {
            ...
            stopWatch.stop();
            log.info("[Ateng]结束请求 => URL[{}],耗时:[{}]毫秒", request.getMethod() + " " + request.getRequestURI(), stopWatch.getTime());
            KEY_CACHE.remove();
        }
    }
